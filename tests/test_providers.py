...
class TestOpenAIProvider:
    ...
    def test_get_capabilities_o3_pro(self):
    ...
    def test_validate_model_names(self):
        ...
        assert provider.validate_model_name("o3pro")
        ...
        assert provider.validate_model_name("gpt-5.3-chat-latest")
