...
class RefactorOpportunity(BaseModel):
    ...
    context_start_text: str = Field("", description="Exact text from start line for verification (optional legacy field)")
    context_end_text: str = Field("", description="Exact text from end line for verification (optional legacy field)")
